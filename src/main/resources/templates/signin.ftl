                ...
                <div class="collapse navbar-collapse justify-content-center" id="nabmune">
                    <ul class="navbar-nav nav-color ">
                        <li class="nav-item active ">
                            <a class="nav-link" href="/signin">登录 <span class="sr-only">(current)</span></a>
                        </li>
                    </ul>
                    <!--<form class="form-inline my-2 my-lg-0">
            <input class="form-control mr-sm-2" type="search" placeholder="Search" aria-label="Search">
                    ...
                    <div class="container">
                        <div class="row mt-2 wow">
                            <div class="col-md-12 bgc">
                                <form class="form-horizontal" id="loginForm" action="/signin" method="post">
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-offset-2 col-sm-10">
                                            <input type="submit" class="btn btn-primary btn-lg" id="denglu" value="登录"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-sm-offset-2 col-sm-10">
