...
<div class="container mt-3">
    <div class="row">
                    ...
                    <div class="personal-userCenter-tabLeftFrame">
                        <div class="personal-userCenter-columns">
                            <ul class="personal-userCenter-columnList">
                                <li class="myCreated"><a href="/space">我发表的</a></li>
                                <#if identity=="owner">
                                    <li class="infoConfig active"><a href="/info">资料设置</a></li>
        ...
        <div class="col-md-10">
            <div class="container">
                <form class="form-horizontal" id="loginForm" action="/info" method="post">
                    <@spring.bind "userDto" />
                    ...
                    <div class="form-group">
                        <label for="email" class="col-sm-4 control-label">修改邮箱</label>
                        <div class="col-sm-8">
                            <@spring.bind "userDto.userEmail" />
                            <input value="${userDto.userEmail!}" type="text" class="form-control" id="email"
                                   placeholder="请输入邮箱地址" name="userEmail">
                            <span class="text-danger"><@spring.showErrors "" /></span>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="password" class="col-sm-4 control-label">修改密码</label>
                        <div class="col-sm-8">
                            <@spring.bind "userDto.userPassword" />
                            <input value="${userDto.userPassword!}" type="password" class="form-control" id="password"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <@spring.bind "userDto.userRePassword" />
                            <input value="${userDto.userRePassword!}" type="password" class="form-control" id="password"
