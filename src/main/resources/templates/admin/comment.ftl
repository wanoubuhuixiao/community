                    ...
                    <table class="layui-table">
                        ...
                        <#list pageInfo.list as a>
                            <tr>
                                ...
                                <td>
                                    ${a.commentCreateTime?string("yyyy-MM-dd")}
                                ...
                                <td>
                                    <a href="javascript:void(0)"
                                       onclick="examineComment(${a.commentId},1)"
                                       class="layui-btn layui-btn-mini">恢复</a>
                                    <a href="javascript:void(0)"
                                       onclick="examineComment(${a.commentId},2)"
                                       class="layui-btn layui-btn-danger layui-btn-mini">删除</a>
                                </td>
                                <td>
                                    <a href="/article/${a.commentArticleId}"
                                       target="_blank">
                                        ${a.commentArticleId}
                                    </a>
                                </td>
                                <td>
                                    <a href="/article/${a.commentArticleId}"
                                       target="_blank">
                                        ${articleService.getArticleById(a.commentArticleId).articleTitle}
                                    </a>
                                </td>
                            </tr>
                        </#list>
