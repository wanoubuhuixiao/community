    ...
    <div class="row">
                        ...
                        <div class="personal-userCenter-columns">
                            <ul class="personal-userCenter-columnList">
                                ...
                                <#if identity=="owner">
                                    ...
                                    <li class="infoConfig active"><a href="/publish">发表文章</a></li>
                                </#if>
                            </ul>
                        </div>
                    </div>
        ...
        <div class="col-md-10">
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        <form class="form-horizontal" id="loginForm" action="/publish" method="post">
                            <@spring.bind "article" />
                            <div class="form-group">
                                <label for="username" class="col-sm-4 control-label">标题</label>
                                <div class="col-sm-8">
                                    <@spring.bind "article.articleTitle" />
                                    <input value="" type="text" class="form-control" id="articleTitle"
                                           placeholder="请输入文章标题" name="articleTitle">
                            ...
                            <div class="form-group">
                                <label for="password" class="col-sm-4 control-label">简介</label>
                                <div class="col-sm-8">
...
<script src="js/jquery1.min.js?v=2.1.4"></script>
<script src="js/bootstrap1.min.js?v=3.3.5"></script>
...
<script>
    $(document).ready(function () {
        var editor = new Simditor({textarea: $("#editor"), defaultImage: "/images/icon_83.5@3x.png"})
    });
</script>
</body>
